...
import { createContext, useCallback, useContext, useEffect, useId, useImperativeHandle, useMemo, useRef, useState } from 'react';
...
export const KanbanBoardContext = createContext<KanbanBoardDndMonitorContextValue | undefined>(undefined);
...
export function KanbanBoardHiddenText({ id, value, className, ref, ...props }: ComponentProps<'div'> & KanbanBoardHiddenTextProps) {
    return (
...
export const KanbanBoardProvider = ({ announcements, screenReaderInstructions, container, children }: KanbanBoardProviderProps) => {
...
export const KANBAN_BOARD_CIRCLE_COLORS = Object.keys(KANBAN_BOARD_CIRCLE_COLORS_MAP) as KanbanBoardCircleColor[];
...
export function KanbanBoardColumnHeader({ className, ref, ...props }: ComponentProps<'div'>) {
    return <div className={cn('flex items-center justify-between px-2 py-1', className)} ref={ref} {...props} />;
}
...
export function KanbanBoardColumnTitle({ className, columnId, ref, ...props }: ComponentProps<'h2'> & KanbanBoardColumnTitleProps) {
    return (
        <h2
            className={cn('inline-flex items-center text-sm font-medium text-muted-foreground', className)}
            ref={ref}
...
export function KanbanBoardColumnIconButton({ className, ref, ...props }: ComponentProps<typeof Button>) {
    return <Button className={cn('size-6 text-muted-foreground', className)} variant="ghost" size="icon" ref={ref} {...props} />;
}
...
export function KanbanColorCircle({ className, color = 'primary', ref, ...props }: ComponentProps<'div'> & KanbanBoardColorCircleProps) {
    return <div className={cn('mr-2 size-2 rounded-full', KANBAN_BOARD_CIRCLE_COLORS_MAP[color], className)} ref={ref} {...props} />;
}

export function KanbanBoardColumnList({ className, ref, ...props }: ComponentProps<'ul'>) {
    return <ul className={cn('min-h-0.5 flex-grow overflow-y-auto', className)} ref={ref} {...props} />;
}
...
export const kanbanBoardColumnListItemClassNames = '-mb-[2px] border-b-2 border-t-2 border-b-transparent border-t-transparent px-2 py-1 last:mb-0';
...
export function KanbanBoardColumnFooter({ className, ref, ...props }: ComponentProps<'div'>) {
    return <div className={cn('flex items-center justify-between px-2 pt-1', className)} ref={ref} {...props} />;
}

export function KanbanBoardColumnButton({ className, ref, ...props }: ComponentProps<typeof Button>) {
    return (
        <Button
            className={cn('w-full justify-start bg-sidebar text-primary hover:text-primary/80', className)}
            variant="outline"
            size="sm"
            ref={ref}
            {...props}
    ...
    return (
        <button
            ...
            className={cn(
                ...
                'inline-flex w-full cursor-grab touch-manipulation flex-col gap-1 focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none',
...
export function KanbanBoardCardDescription({ className, ref, ...props }: ComponentProps<'p'>) {
    return <p className={cn('text-xs leading-5 whitespace-pre-wrap text-card-foreground', className)} ref={ref} {...props} />;
}

export function KanbanBoardCardTextarea({ className, onChange, value, ref: externalReference, ...props }: ComponentProps<'textarea'>) {
    ...
    return (
        <Textarea
            className={cn(kanbanBoardCardClassNames, 'min-h-min resize-none overflow-hidden text-xs leading-5', className)}
...
export function KanbanBoardCardButtonGroup({ className, disabled = false, ref, ...props }: ComponentProps<'div'> & KanbanBoardCardButtonGroupProps) {
    return (
        <div
            ref={ref}
            className={cn(
                'absolute top-2.5 right-2.5 z-40 hidden items-center bg-background',
 ...
 */
export function KanbanBoardCardButton({ className, tooltip, ref: externalReference, ...props }: ComponentProps<'div'> & KanbanBoardCardButtonProps) {
