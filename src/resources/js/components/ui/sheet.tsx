    ...
    return (
        <SheetPortal>
            ...
            <SheetPrimitive.Content
                ...
                className={cn(
                    'fixed z-50 flex flex-col gap-4 bg-white dark:bg-background shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=closed]:animate-out data-[state=open]:duration-500 data-[state=open]:animate-in',
                    side === 'right' &&
